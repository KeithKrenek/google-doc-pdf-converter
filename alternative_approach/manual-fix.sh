...
# Manual fix for PDF conversion error
# Simple approach without complex logging commands
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Manual PDF Fix - ReportLab Solution${NC}"
echo -e "${BLUE}========================================${NC}"
...
# Create new requirements.txt with ReportLab
echo -e "${YELLOW}🔧 Creating new requirements.txt with ReportLab...${NC}"
...
echo -e "${GREEN}✅ Created new requirements.txt${NC}"

# Create new main.py with ReportLab
echo -e "${YELLOW}🔧 Creating new main.py with ReportLab PDF generation...${NC}"
...
echo -e "${GREEN}✅ Created new main.py with ReportLab${NC}"
...
echo -e "${YELLOW}⏳ Waiting for deployment (60 seconds)...${NC}"
sleep 60

# Test
echo -e "${YELLOW}🧪 Testing new version...${NC}"
SERVICE_URL=$(gcloud run services describe doc-to-pdf-converter --region=$REGION --format="value(status.url)")
